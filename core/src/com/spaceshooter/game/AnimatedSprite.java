...
public class AnimatedSprite {
	...
	public AnimatedSprite(Sprite sprite)
	{
		...
		TextureRegion[][] temp = TextureRegion.split(texture, texture.getWidth() / FRAMES_COL, texture.getHeight() / FRAMES_ROW); // setup a 2D array as a temp container of our sprite.
